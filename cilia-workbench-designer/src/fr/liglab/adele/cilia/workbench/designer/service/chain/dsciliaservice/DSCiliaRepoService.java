...
public class DSCiliaRepoService extends ChainRepoService<DSCiliaFile, DSCiliaModel, DSCiliaChain> {
	...
	public void createMediator(DSCiliaChain chain, String id, MediatorDefinition type) throws CiliaException {
		if (getFileFromChain(chain) == null)
			return;
		getFileFromChain(chain).getModel().createMediator(chain, id, type);
	}

	public void createAdapter(DSCiliaChain chain, String id, AdapterDefinition type) throws CiliaException {
		if (getFileFromChain(chain) == null)
			return;
