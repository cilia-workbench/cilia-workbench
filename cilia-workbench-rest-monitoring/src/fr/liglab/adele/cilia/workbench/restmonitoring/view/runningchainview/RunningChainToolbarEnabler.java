 ...
 */
public class RunningChainToolbarEnabler extends ToggleSourceProvider {
	public final static String VARIABLE_NAME = "fr.liglab.adele.cilia.workbench.restmonitoring.view.runningchainview.RunningChainToolbarEnabler";
	...
	public RunningChainToolbarEnabler() {
