...
public class ReflectionUtil {
	...
	// private static boolean setAttribute(Node node, String attrName, Object
	// object, String fieldName) throws CiliaException {
	// return setAttribute(node, attrName, object, fieldName, null);
	// }
	//
	// private static boolean setAttribute(Node node, String attrName, Object
	// object, String fieldName, String defaultValue) throws CiliaException {
	// return setAttributeInternal(false, defaultValue, node, attrName, object,
	// fieldName);
	// }
	//
	// private static boolean setAttributeInternal(boolean requiredAttribute,
	// String defaultValue, Node node, String attrName, Object object, String
	// fieldName)
