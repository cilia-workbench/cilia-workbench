 ...
 */
public abstract class ChainFile<ModelType extends ChainModel<ChainType>, ChainType extends Chain> extends AbstractFile<ModelType> {

	public ChainFile(PhysicalResource resource) {
		super(resource);
	}
